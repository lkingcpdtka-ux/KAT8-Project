#!/usr/bin/env Rscript
################################################################################
## KAT8 Knockdown RNA-seq Analysis Pipeline - Master Script
##
## This script runs all 3 parts of the analysis in sequence:
##   1. part1_main_analysis.R  - DESeq2 differential expression analysis
##   2. part2_ora.R            - Over-representation analysis (ORA)
##   3. part3_fgsea.R          - Gene set enrichment analysis (fgsea)
##
## USAGE:
##   Rscript run_all.R
##
...
cat("\n")
cat("================================================================================\n")
cat("=== KAT8 KNOCKDOWN RNA-SEQ ANALYSIS PIPELINE ===\n")
cat("================================================================================\n")
...
run_part("part1_main_analysis.R", 1, "DESeq2 Analysis")

## Part 2: Over-representation analysis
run_part("part2_ora.R", 2, "ORA Analysis")

## Part 3: Gene set enrichment analysis
run_part("part3_fgsea.R", 3, "FGSEA Analysis")
...
timing_file <- file.path("output", "logs",
                        paste0("pipeline_timing_", format(Sys.time(), "%Y%m%d_%H%M%S"), ".csv"))
...
cat("\n")
cat("All analysis complete! Check the output directory for results.\n")
cat("\n")
