...
## Wald statistics from the unified model are used for ranking.
## =========================================================
...
tryCatch({
  ...
  for (de_file in de_files) {
    ...
    ## Key on the gene_name column, NOT rownames(): dplyr::filter/arrange
    ## drop row names, so rownames(ranked_genes) would be "1","2",... and
    ## fgsea/gseGO would then match ~zero genes to any pathway.
